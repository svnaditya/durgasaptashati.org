    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-blue-50">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-xl shadow-md mb-6 p-6">
          ...
          ಕಲಬುರ್ಗಿಯ ಶ್ರೀ ರಾಮಕೃಷ್ಣ ವಿವೇಕಾನಂದ ಆಶ್ರಮದಲ್ಲಿ ನವೆಂಬರ್ ತಿಂಗಳ 25,26,27 ಮತ್ತು 28 ರಂದು ಶ್ರೀ ಶ್ರೀ ಶ್ರೀ ಆಯುತ ಚಂಡಿಕಾ ಮಹಾಯಾಗ ಮಾಡಲು ಸಂಕಲ್ಪಿಸಿದ್ದೇವೆ.
          ಮಹಾಯಾಗದ ಪೂರ್ವಭಾವಿಯಾಗಿ 1 ಕೋಟಿ ನವಾರ್ಣ ಜಪ ಮಾಡಬೇಕಾಗಿದೆ. ದಯವಿಟ್ಟು ಶ್ರೀ ದುರ್ಗಾ ಸಪ್ತಶತಿಯನ್ನು ಕಲಿತಿರುವಂತವರು ಭಾಗವಹಿಸಬೇಕಾಗಿ ವಿನಂತಿ.
          <br />
          <br />
          <b>ನವಾರ್ಣ ಮಂತ್ರ ದೀಕ್ಷೆ ಬೇಕಿದ್ದರೆ, ಕೆಳಗಿನ ನಂಬರ್ ಗೆ ಕಾಲ್ ಮಾಡಿ.</b>
          <br />
          <br />
          ಸಂಪರ್ಕ : ಸ್ವಾಮಿ ಮಹೇಶ್ವರಾನಂದಜಿ
          <br />
          ನಂ: 9019849144(<a target="_blank" href="https://wa.me/9019849144" className="text-blue-500">whatsapp</a>) | 9632322577
        </div>
